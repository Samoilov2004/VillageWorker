...
Label был выбран для каждого объявления из списка
```Python
JOB_LABELS = [
  "IT/разработка",
  "Аналитика/данные",
  "Маркетинг/PR/контент",
  "Продажи/аккаунт-менеджмент",
  "Поддержка/колл-центр",
  "Финансы/бухгалтерия",
  "HR/рекрутинг",
  "Юриспруденция",
  "Административный персонал/офис",
  "Производство/инженерия",
  "Строительство/недвижимость (работы)",
  "Логистика/склад/закупки",
  "Транспорт/доставка (водители/курьеры)",
  "Медицина/фарма",
  "Образование",
  "Ритейл (магазин/касса)",
